package com.example.llp.androiduipractice.RecyclerView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.linear) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                position = linearLayoutManager.findFirstCompletelyVisibleItemPosition();//获取第一个完全可见的Item的位置


            } else if(layoutManager instanceof StaggeredGridLayoutManager){
                StaggeredGridLayoutManager staggeredGridLayoutManager = (StaggeredGridLayoutManager)layoutManager;
                int positions[] = new int[2];
                staggeredGridLayoutManager.findFirstCompletelyVisibleItemPositions(positions);
